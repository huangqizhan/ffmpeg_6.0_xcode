...
/* the following codec id fields are deprecated in favor of codec_id */
    ...
    FFPicture *picture;          ///< main picture buffer
    FFPicture **input_picture;   ///< next pictures on display order for encoding
    FFPicture **reordered_input_picture; ///< pointer to the next pictures in coded order for encoding
     ...
     */
    FFPicture last_picture;

    /**
     * copy of the next picture structure.
     * note, linesize & data, might not match the next picture (for field pictures)
     */
    FFPicture next_picture;
     ...
     */
    FFPicture current_picture;    ///< buffer to store the decompressed current picture

    FFPicture *last_picture_ptr;     ///< pointer to the previous picture.
    FFPicture *next_picture_ptr;     ///< pointer to the next picture (for bidir pred)
    FFPicture *current_picture_ptr;  ///< pointer to the current picture
